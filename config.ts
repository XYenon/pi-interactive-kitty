...
export function loadConfig(cwd: string): InteractiveShellConfig {
	...
	return {
		...merged,
		focusShortcut: resolveNonEmptyString(merged.focusShortcut, DEFAULT_CONFIG.focusShortcut),
...
function resolveString(value: unknown, fallback: string): string {
	return resolveNonEmptyString(typeof value === "string" ? value : undefined, fallback);
}
...
function resolveNonEmptyString(value: string | undefined, fallback: string): string {
...
function resolveShortcut(value: string | undefined, fallback: string): string {
	return resolveNonEmptyString(value, fallback);
}
